...
void qr_2d_unit_test(int64_t const m,
...
#endif
  if (myRank == 0)  
    printf("unit testing parallel 2D tree QR...\n");
  ...
  if (myRank == 0)
    printf("Performing 2D QR with tree updates on matrix [A,A]:\n");
  ...
  QR_tree_2D(A,mb,m,2*k,b,myRank,numPes,0,0,cdt_row,cdt_col,cdt,MIN(m,k));
